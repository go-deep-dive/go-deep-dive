...
| nil 채널    | `var ch chan int // 초기화 안함` | 송수신 모두 **영원히 블로킹**, 동적 제어에 사용          |
...
* 만약 ch1, ch2 채널에 값이 동시에 수신되는 경우 두 case문 중 하나 랜덤으로 수행됨
